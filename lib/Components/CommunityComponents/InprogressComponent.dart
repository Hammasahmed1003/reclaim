...
class InProgressComponent extends StatelessWidget {
  ...
  decoration:  BoxDecoration(
    color: isFulfilled ? Reclaimcolors.BasicBlue.withOpacity(0.15) : Reclaimcolors.BasicBlue, // Background color
    borderRadius: BorderRadius.circular(20), // More rounded corners
    border: Border.all(color:isFulfilled ? Colors.white : Reclaimcolors.BlueSecondary, width: 2), // Blue border
    boxShadow: [
      BoxShadow(
        color: isFulfilled ? Colors.white : Reclaimcolors.BlueSecondary, // Glowing effect
 ...
 SvgPicture.asset(
  isFulfilled ?
  ReclaimIcon.tic : ReclaimIcon.time,
  color: isFulfilled ? 
  Colors.green : Reclaimcolors.BlueSecondary,
  width: 20,
  height: 20,
  ),
  SizedBox(width: 16,),
      ...
      Text(
        isFulfilled ?
        "Fulfilled" : "InProgress",
        style: TextStyle(
          color: isFulfilled ? Reclaimcolors.BasicBlack : Reclaimcolors.BasicWhite, // Blue text when unselected
          fontWeight: FontWeight.bold,
          fontSize: 18,
        ),
      ),

        ...
        child: SingleChildScrollView(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Text("Setup Your Profile From Here!",
                style: TextStyle(
                  fontSize: 18.sp,
            ...
            //       image: profilesetupcontroller.selectedImage.value != null
            //           ? DecorationImage(
            //     image: FileImage(profilesetupcontroller.selectedImage.value!),
            //     fit: BoxFit.cover,
            //   )
            //           : null,
            //     ),
            //     child: profilesetupcontroller.selectedImage.value == null
            //         ?  Center(
            //   child:
            //   //  Icon(
            //   //   Icons.camera_alt,
            ...
            //   //   size: 40,
            //   // ),
            //   SvgPicture.asset(ReclaimIcon.userIcon, 
      ...
      children: [
        ...
        Column(
                    ...
                    Expanded(
                      child: CupertinoDatePicker(
                        ...
                        onDateTimeChanged: (DateTime newDate) {
                          profilesetupcontroller.updateDateOfBirth(newDate);
                        },
                      ),
                    ),
                  ],
          ...
          child: ReclaimTextField(
            ...
            isPassword: false,
            hintColor: Reclaimcolors.BasicBlack.withOpacity(0.35),
            controller: profilesetupcontroller.dateOfBirthController,
          ),
                ),
              ),
          ...
          Column(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: AbsorbPointer(
          child: 
          ReclaimTextField(hintText: "Gender", filledColor: Reclaimcolors.BasicWhite, activeBorderColor: Reclaimcolors.BasicWhite, controller: profilesetupcontroller.genderController)
          ...
          //   width: 370.w, height: 48.h, backgroundColor: Reclaimcolors.BasicBlue, title: "Continue", fontWeight: FontWeight.w600, onPressed: (){

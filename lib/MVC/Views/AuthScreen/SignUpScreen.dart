      ...
      child: Scaffold(
              ...
              body: Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  // Get.toNamed(GetRouteNames.Otpscreen);
                  ...
                  , 
                   ...
                   RichText(
                    text: TextSpan(
                      ...
                      style: const TextStyle(color: Reclaimcolors.BasicBlack, fontSize: 17, fontWeight: FontWeight.w300),
                      children: [
                        TextSpan(
                          text: "LogIn",
                          style: const TextStyle(color: Reclaimcolors.BasicBlue, fontSize: 17, fontWeight: FontWeight.bold),
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(text: "By Signing Up/Logging In. You Agree To Our "),
                        TextSpan(
                          text: "Terms Of Service",
                          style: TextStyle(color: Reclaimcolors.BasicBlue, fontWeight: FontWeight.w400),
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
                        ...
                        TextSpan(
                          text: "Privacy Policy",
                          style: const TextStyle( color: Reclaimcolors.BasicBlue, fontWeight: FontWeight.w400),
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
